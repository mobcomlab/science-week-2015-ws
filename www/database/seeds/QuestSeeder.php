    ...
    public function run()
    {
        ...
        DB::table('quest')->insert([
            ...
            [
                'id' => '12',
                'type' => '1',
                'text'=>'พระบิดาแห่งวิทยาศาสตร์ไทยคือรัชกาลใด:ตราสัญลักษณ์คณะวิทยาศาสตร์ มหาลัยนเรศวร ประกอบไปด้วยอะไรบ้าง:งานสัปดาห์วิทยาศาสตร์ที่ คณะวิทยาศาสตร์ มหาวิทยาลัยนเรศวรจัดขึ้นเป็นครั้งที่เท่าไหร่:คณะวิทยาศาสตร์ มหาวิทยาลัยนเรศวรมีกี่สาขา:ประเทศใดสามารถส่งยานอวากาศไปโคจรรอบโลกได้เป็นประเทศเเรก',
                'answer'=>'รัชกาลที่ 2:รูปช้าง กับ อะตอม:ครั้งที่ 26:8 สาขา:ประเทศรัสเซีย',
                'other'=>'รัชกาลที่ 3,รัชกาลที่ 6,รัชกาลที่9:รูปช้าง กับ สายรุ้ง,รูปช้าง กับ พระจันทร์ครึ่งเสี้ยว,รูปช้าง กับ สายฟ้า:ครั้งที่ 25,ครั้งที่ 24, ครั้งที่ 27:7 สาขา,6 สาขา,5 สาขา:ประเทศสหรัฐอเมริกา,ประเทศจีน,ประเทศไทย',
                'title'=>'คำถาม',
                'icon'=>'quest',
                'color'=>'#FFEB3B',
                'status'=>'0',
            ...
            [
                ...
                'other'=>'1. เล่นเกมนี้ที่ห้อง SC2-208 ตึกคณิตศาสตร์คณะวิทยาศาสตร์ ,2. เกมนี้จะเป็นเกมเกี่ยวกับการแยกขยะ และการคำนวณตัวเลข(เกม24),3. เล่นเกมให้ผ่านตามเควสเพื่อสแกน QR-code เเทนการปั๊มแสตมป์',
                'title'=>'สถิติพาเพลิน',
                'icon'=>'math',
                'color'=>'#26A69A',
                'status'=>'0',
